...
# Nothing's modem tunnel directly calls INothingTelephony for OEM radio events.
# Keep the exact small B4.1 interface jar on the boot class path; the
# nt-telephony-common implementation remains an ordinary system_ext prebuilt.
PRODUCT_PACKAGES += \
